...
import { EmbeddedGraph } from '../graph.js'
import type { MemoryStoreAdapter, SemanticEntity, SemanticEdge, MemoryScope } from '@d8um/memory'
...
function mockStore(
  ...
  return {
    ...
    findEntities: vi.fn().mockImplementation(async (query: string, _scope: MemoryScope) => {
