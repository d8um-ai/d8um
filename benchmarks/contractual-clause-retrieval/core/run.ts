#!/usr/bin/env npx tsx
/**
 * Contractual Clause Retrieval Benchmark — d8um Core (Hybrid Search)
 *
 ...
 *
 * Usage:
 *   npx tsx contractual-clause-retrieval/core/run.ts           # query-only
 *   npx tsx contractual-clause-retrieval/core/run.ts --seed    # re-index
 */
...
const BUCKET_NAME = 'contractual-clause'
const TABLE_PREFIX = 'bench_contract_core_'
...
async function main() {
  ...
  console.log('╔══════════════════════════════════════════════════════════════╗')
  console.log('║  Contractual Clause Retrieval — d8um Core (Hybrid Search)   ║')
  console.log('╚══════════════════════════════════════════════════════════════╝')
  console.log()
