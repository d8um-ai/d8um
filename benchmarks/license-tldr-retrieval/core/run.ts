#!/usr/bin/env npx tsx
/**
 * License TLDR Retrieval Benchmark — d8um Core (Hybrid Search)
 *
 ...
 * Software license document retrieval from TLDR descriptions.
 *
 * Required env vars:
 *   NEON_DATABASE_URL, AI_GATEWAY_API_KEY, BLOB_READ_WRITE_TOKEN
 *
 * Usage:
 *   npx tsx license-tldr-retrieval/core/run.ts           # query-only
 *   npx tsx license-tldr-retrieval/core/run.ts --seed    # re-index
 */
...
const BUCKET_NAME = 'license-tldr'
const TABLE_PREFIX = 'bench_license_core_'
...
async function main() {
  ...
  console.log('╔══════════════════════════════════════════════════════════════╗')
  console.log('║  License TLDR Retrieval — d8um Core (Hybrid Search)         ║')
  console.log('╚══════════════════════════════════════════════════════════════╝')
  console.log()
