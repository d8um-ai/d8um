#!/usr/bin/env npx tsx
/**
 * Australian Tax Guidance Retrieval Benchmark — d8um Core (Hybrid Search)
 *
 ...
 *
 * Usage:
 *   npx tsx australian-tax-guidance-retrieval/core/run.ts           # query-only
 *   npx tsx australian-tax-guidance-retrieval/core/run.ts --seed    # re-index
 */
...
const BUCKET_NAME = 'au-tax-guidance'
const TABLE_PREFIX = 'bench_au_tax_core_'
...
async function main() {
  ...
  console.log('╔══════════════════════════════════════════════════════════════╗')
  console.log('║  AU Tax Guidance Retrieval — d8um Core (Hybrid Search)      ║')
  console.log('╚══════════════════════════════════════════════════════════════╝')
  console.log()
